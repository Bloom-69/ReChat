...
import ServerWideChanger from "./ServerWide";
            ...
            <List>
              ...
              <ListItem>
                ...
                <TextField
                  label="Status Text"
                  variant="standard"
                  value={ReChat.settings.statusText}
                  onChange={(e) =>
                    ReChat.setSettings("statusText", e.currentTarget.value)
                  } />
              </ListItem>
              <ListItem>
                <ListItemIcon>
                ...
                <ListItemText primary="Custom Status" secondary="Use your customized status" />
                <Button startIcon={<OpenInFull />} onClick={() => ReChat.setShowCustom(true)}>Open Custom Status</Button>
              </ListItem>
            </List>
          </Match>
          {ReChat.settings.experiments.app_appearance &&
          ...
          <Match when={Tab() === 5}>
            <Container sx={{ marginTop: 1 }}>
              <Card variant="outlined">
                <CardHeader title="ReChat (In-Dev)" subheader="Version 0.4 (Codename: Tungsten Hyacinthine)" />
                <CardContent>
