        ...
        return (
            <div class="flex items-center gap-2">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div>
                        <Markdown content={`:01GJTC4RD6XAJXRAAM30KW25VD: | Bye, ${sysmessage.detail.user.username}!`} />
                    </div>
                </div>
            </div>
        )
        ...
        return (
            <div class="flex items-center gap-2">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div>
                        <Markdown content={`:01GJTC4RD6XAJXRAAM30KW25VD: | ${sysmessage.detail.user.username} was ejected because he was too suspicious`} />
                    </div>
                </div>
            </div>
        )
        ...
        return (
            <div class="flex items-center gap-2">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div>
                        <Markdown content={`:01GJTC4RD6XAJXRAAM30KW25VD: | ${sysmessage.detail.user.username} was struck by the ban hammer`} />
                    </div>
                </div>
            </div>
        )
